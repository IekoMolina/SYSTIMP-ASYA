...
<head>
    ...
    <title>Subordinate Resignation</title>
</head>
<body>
                    ...
                    <!-- FORMS -->
						...
						<div class="list-group collapse" id="penreq-items">
							...
							<!-- FORMS -->
								...
								<a href="Subordinate - Resignation.php" class="list-group-item active">Resignation</a>
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td>HR</td>
                                <td>HR Manager</td>
                                <td>Company is too far from my residence</td>
								<td>
									<div class="col-md-12">
										<input type="submit" name="submit" value="Accept"/>
										<input type="submit" name="submit" value="Reject"/>
