...
<head>
    ...
    <title>Subordinate Change Record</title>
</head>
<body>
                ...
                <div class="list-group collapse" id="sub-items">
                    ...
                    <!-- FORMS -->
						...
						<div class="list-group collapse" id="penreq-items">
							...
							<!-- FORMS -->
								<a href="Subordinate - Absent Reversal.php" class="list-group-item">Leave</a>
								<a href="Subordinate - Change Record.php" class="list-group-item active">Change Record</a>
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td>Change my middle name from Horhe to Jorge</td>
                                <td>Typo on my name</td>
								<td>
									<div class="col-md-12">
                           ...
                           <tr>
                                ...
                                <td>HR</td>
                                <td>HR Manager</td>
                                <td>Change last name from Rizal to Cruz</td>
                                <td>Just got married</td>
								<td>
									<div class="col-md-12">
										<input type="submit" name="submit" value="Accept"/>
										<input type="submit" name="submit" value="Reject"/>
