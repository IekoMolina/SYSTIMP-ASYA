...
<head>
    ...
    <title>Itinerary Authorization Report</title>
</head>
<body>
            ...
            <div class="list-group root">
                ...
                <div class="list-group collapse" id="report-items">
                    <!-- employee reports -->
                        ...
                        <a href="ItineraryAuthorizationReport.php" class="list-group-item active">&#x25cf Itinerary Authorization</a>					
                </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default" id="applicants-panel">
                    <div class="panel-heading" align="center">
						...
						ASYA <br>
						Itinerary Authorization Report						
						</h3>
                    </div>
